...
import { REM } from './global/helpers/mediaDimensions';

import useAppLayout from './hooks/useAppLayout';
import useHorizontalScroll from './hooks/useHorizontalScroll';
import useLastCallback from './hooks/useLastCallback';
import useScrolledState from './hooks/useScrolledState';
import useAsyncRendering from './hooks/right/useAsyncRendering';
...
const CustomEmojiPicker: FC<OwnProps & StateProps> = ({
  ...
  const allSets = useMemo(() => {
    ...
    customEmojiFeaturedIds, stickerSetsById,
    defaultStatusIconsId, defaultTopicIconsId, isSavedMessages, chatEmojiSetId,
    isWithPaidReaction,
  ]);
  ...
  if (!shouldRenderContent) {
    return (
      <div className={fullClassName}>
        {noPopulatedSets ? (
          <div className={pickerStyles.pickerDisabled}>{"No stickers"}</div>
        ) : (
          <Loading />
        )}
      </div>
  ...
  return (
    <div className='SymbolMenu'>
      <div className='SymbolMenu-main' style={{height: `${customHeight}px`}}>
        <div className={fullClassName}>
          <div
            ref={headerRef}
...
export default memo(withGlobal<OwnProps>(
  (global, { chatId, isStatusPicker, isReactionPicker }): StateProps => {
    ...
    const chatFullInfo = chatId ?? undefined;
