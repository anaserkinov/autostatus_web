import type { RefObject } from '../teact/teact';
import { useLayoutEffect, useRef, useSignal } from '../teact/teact';
import { addExtraClass, toggleExtraClass } from '../teact/teact-dom';
